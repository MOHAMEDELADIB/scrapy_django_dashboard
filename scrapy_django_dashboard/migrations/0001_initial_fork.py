    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scraped_obj_class', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='scrapy_django_dashboard.ScrapedObjClass')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scraped_obj_attr', models.ForeignKey(help_text='The different attributes to be scraped, exactly one attribute of type BASE necessary.', on_delete=django.db.models.deletion.DO_NOTHING, to='scrapy_django_dashboard.ScrapedObjAttr')),
                ('scraper', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='scrapy_django_dashboard.Scraper')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(blank=True)),
                ('scraped_obj_attr', models.ForeignKey(blank=True, help_text='Empty for main page, attribute of type DETAIL_PAGE_URL scraped from main page for detail pages.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='scrapy_django_dashboard.ScrapedObjAttr')),
                ('scraper', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='scrapy_django_dashboard.Scraper')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scraper', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='scrapy_django_dashboard.Scraper')),
            ],
        ),
        migrations.CreateModel(
            name='Log',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(blank=True)),
                ('scraped_obj_attr', models.ForeignKey(help_text='Attribute of type DETAIL_PAGE_URL, several checkers for same DETAIL_PAGE_URL attribute possible.', on_delete=django.db.models.deletion.DO_NOTHING, to='scrapy_django_dashboard.ScrapedObjAttr')),
                ('scraper', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='scrapy_django_dashboard.Scraper')),
            ],
        ),
    ]
