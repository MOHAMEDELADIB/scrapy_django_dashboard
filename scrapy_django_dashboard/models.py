...
class RequestPageType(models.Model):
    ...
    # dynamic_scraper.RequestPageType.page_type: (fields.E009) 'max_length' is too small to fit the longest value in 'choices' (4 characters).
    page_type = models.CharField(max_length=4, choices=TYPE_CHOICES, help_text=help_text)
    # https://stackoverflow.com/a/44026807
    scraped_obj_attr = models.ForeignKey(ScrapedObjAttr, on_delete=models.DO_NOTHING, blank=True, null=True, help_text="Empty for main page, attribute of type DETAIL_PAGE_URL scraped from main page for detail pages.")
...
class Checker(models.Model):
    ...
    # https://stackoverflow.com/a/44026807
    scraped_obj_attr = models.ForeignKey(ScrapedObjAttr, on_delete=models.DO_NOTHING, help_text="Attribute of type DETAIL_PAGE_URL, several checkers for same DETAIL_PAGE_URL attribute possible.")
    scraper = models.ForeignKey(Scraper, on_delete=models.DO_NOTHING)
...
class ScraperElem(models.Model):
    ...
    scraped_obj_attr = models.ForeignKey(ScrapedObjAttr, on_delete=models.DO_NOTHING, help_text=help_text)
    scraper = models.ForeignKey(Scraper, on_delete=models.DO_NOTHING)   
...
class LogMarker(models.Model):
    ...
    scraper = models.ForeignKey(Scraper, on_delete=models.DO_NOTHING, blank=True, null=True)
